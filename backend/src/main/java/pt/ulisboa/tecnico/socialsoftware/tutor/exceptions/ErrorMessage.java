...
public enum ErrorMessage {
    ...
    AT_LEAST_TWO_ORDERED_OPTIONS_NEEDED("Sorting Questions need to have at least 2 ordered options"),
    SORTING_CONFLICT("The orders must be different in Sorting Question."),
    ...
    TWO_AND_ONLY_TWO_ITEM_GROUPS_NEEDED("Item combination questions need two and only two item groups"),
    ITEM_GROUPS_CANT_BE_EMPTY("Item groups need to contain atleast an item"),
    ITEM_GROUP_NOT_FOUND("Item group not found with id %d"),
    ITEM_NOT_FOUND("Item not found with id %d"),
    COMB_INDEX_OUT_OF_BOUNDS("Item combination outside of item group size");
