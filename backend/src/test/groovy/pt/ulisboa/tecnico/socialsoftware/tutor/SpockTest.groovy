...
class SpockTest extends Specification {
    ...
    public static final String OPEN_ANSWER_CORRECT_ANSWER = "Open Answer correct answer 1"
    public static final String OPEN_ANSWER_CORRECT_ANSWER2 = "Open Answer correct answer 2"
