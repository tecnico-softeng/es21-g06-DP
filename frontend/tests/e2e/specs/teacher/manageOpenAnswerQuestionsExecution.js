describe('Manage Open Answer Questions Walk-through', () => {
  function validateQuestion(title, content, correctAnswer) {
    cy.get('[data-cy="showQuestionDialog"]')
      ...
      .within($ls => {
        ...
        cy.get('[data-cy="content-image"]').should('contain', content);
        cy.get('[data-cy="correctAnswer"]').should('contain', correctAnswer);
      });
  }

  function validateQuestionFull(title, content, correctAnswer) {
    cy.log('Validate question with show dialog. ' + correctAnswer);
  ...
  it('Creates a new open answer question', function() {
    ...
    cy.get('[data-cy="Correct-answer"]')
      .type('Cypress Question Example - Correct Answer - 01', { force: true })
      .click({ force: true });
  ...
  it('Can update content (with button)', function() {
    ...
    cy.get('[data-cy="createOrEditQuestionDialog"]')
      ...
      .within($list => {
        ...
        cy.get('[data-cy="Correct-answer"]')
          .clear({ force: true })
          .type('New correct answer!', { force: true });
  ...
  it('can delete a created open answer question', function() {
